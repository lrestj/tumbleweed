...
Apps="autofs avahi baobab kf6-breeze-icons breeze6-cursors brightnessctl btop cliphist cmake cups eog evince fastfetch fd figlet firewall-config firewall-applet fish file-roller font-manager fontawesome-fonts foot geany gnome-calculator git gnome-disk-utility go google-noto-coloremoji-fonts google-noto-fonts grim gthumb gvfs-backends gvim hplip hyprland hypridle hyprlock hyprland-qt-support hyprland-qtutils hyprwayland-scanner intel-media-driver jetbrains-mono-fonts jq Mesa-libGL1 libtool libXt-devel libnotify-devel libreoffice-gtk3 lxqt-policykit mako NetworkManager-applet nfs-client nwg-look opi pamixer pavucontrol pcmanfm-qt-lang power-profiles-daemon pipewire pipewire-jack libnotify-tools libqt5-qtwayland qt6ct rofi rsvg-thumbnailer simple-scan slurp swaybg swayidle swaylock symbols-only-nerd-fonts thunar thunar-archive-plugin gvfs-fuse gvfs-backend-samba tmux udiskie libva-utils waybar wireplumber wl-clipboard wireplumber wlogout wlsunset wofi xdg-desktop-portal-hyprland xdg-user-dirs xournalpp xwayland yazi"
